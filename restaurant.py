...
def update_profile(user_json, id, new_name, new_phone,new_age,new_password):
        file = open(user_json,"r+")
        content = json.load(file)
        ...
        for i in range (len(content)):
            if content[i]['id'] == id:
                ...
                content[i]['phone number'] = new_phone
                content[i]['age'] = new_age
                content[i]['password'] = new_password
                print("Id: ", content[i]["id"])
                print(f"---> Name: {content[i]['name']}")
                print(f"---> Phone: {content[i]['phone number']}")
                print(f"---> Adress: {content[i]['age']}")
                        ...
                        if content[i]["password"] == password:
                            while True:
                                ...
                                if val3 == "1":
                                    ...
                                    update_profile('user.json', id, new_name, new_phone,new_age,new_password)
                                else:
                ...
                if content["name"] == user:
                    if content["password"] == password:
                        while True:
                            ...
                            print("4) Remove Food") 
                            print("5) Exit")
                            val4 = input("Enter Your Choice Admin!!")
                            if val4 == "1":
